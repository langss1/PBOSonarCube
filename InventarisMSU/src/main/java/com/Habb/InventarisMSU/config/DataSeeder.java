...
public class DataSeeder implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
            ...
            logger.error("ERROR IN DATA SEEDER: {}", e.getMessage(), e);
        }
        }
        ...
        private void seedUsers() {
                if (userRepository.count() == 0) {
                        ...
                        pengelola.setPassword(passwordEncoder.encode(DEFAULT_PASSWORD));
                        pengelola.setRole(Role.PENGELOLA);
                        userRepository.save(pengelola);

                        User pengurus = new User();
                        pengurus.setEmail("pengurus@msu.com");
                        pengurus.setPassword(passwordEncoder.encode(DEFAULT_PASSWORD));
        ...
        private void seedItems() {
                ...
                createItemIfNotExists("Ruang VIP", ItemType.RUANGAN, 1, "plaza.jpeg", "Ruang VIP (Kapasitas: 20 Orang)",
                                20);
                ...
                createItemIfNotExists("Plaza", ItemType.RUANGAN, 1, "plaza.jpeg", "Plaza Masjid (Kapasitas: 800 org)",
                                800);
        }
        ...
        private void createLoanWithEmail(String borrower, String email, String itemName, int qty, String start,
                        String end,
                        PeminjamanStatus status, DateTimeFormatter fmt) {
                ...
                if (item != null) {
                        ...
                        boolean isTaken = (status == PeminjamanStatus.TAKEN || status == PeminjamanStatus.COMPLETED
                                        || status == PeminjamanStatus.RETURNED);
                        boolean isReturned = (status == PeminjamanStatus.COMPLETED
                                        || status == PeminjamanStatus.RETURNED);
